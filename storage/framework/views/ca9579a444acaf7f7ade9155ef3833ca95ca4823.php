...
body {
    height: 100vh;
    background-image: url("<?php echo e(asset('image')); ?>/pantai.jpg")
}
            ...
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="login_script.php" method="POST">
                        ...
                        <a href="/" class="btn btn-primary btn-block mt-3">Login</a>
...
<?php /**PATH C:\Users\Daffa Hafizh R\OneDrive\Documents\Codingan\projek2\projek2\resources\views/v_login.blade.php ENDPATH**/ ?>