  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	...
	<div class="Eksterior">
		<div class="p-3 mb-2 bg-light text-dark">
		  <div class="row no-gutters dark-text " data-scrollax-parent="true">
			<div class="col-md-9 ftco-animate " data-scrollax=" properties: { translateY: '70%' }">
			  
			  <h2 class="display-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Exterior</h2>
		  </div>
		</div>
		</div>
		<figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2023-03-20.jpg" class="figure-img img-fluid rounded" width="576px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/20220110_133542.jpg" class="figure-img img-fluid rounded" width="678px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2020-11-01.jpg" class="figure-img img-fluid rounded" width="576px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/20230604_105746.jpg" class="figure-img img-fluid rounded" width="678px">
			<figcaption class="figure-caption">	</figcaption>
		  </figure>
	</div>
		...
		<div class="p-3 mb-2 bg-light text-dark">
		  <div class="row no-gutters dark-text " data-scrollax-parent="true">
			<div class="col-md-9 ftco-animate " data-scrollax=" properties: { translateY: '70%' }">
			  ...
			  <h2 class="display-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Inferior</h2>
		  </div>
		</div>
		</div>
		<figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2019-11-18.jpg" class="figure-img img-fluid rounded" width="467px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2023-12-22 (1).jpg" class="figure-img img-fluid rounded" width="268px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2023-06-03 (1).jpg" class="figure-img img-fluid rounded" width="268px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/IMG_20220917_211728.jpg" class="figure-img img-fluid rounded" width="268px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
	</div>
	<div class="Fasilitas">
		<div class="p-3 mb-2 bg-light text-dark">
		  <div class="row no-gutters dark-text " data-scrollax-parent="true">
			<div class="col-md-9 ftco-animate " data-scrollax=" properties: { translateY: '70%' }">
			  ...
			  <h2 class="display-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Fasilitas</h2>
		  </div>
		</div>
		</div>
		<figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2022-07-21.jpg" class="figure-img img-fluid rounded" width="576px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2023-08-05.jpg" class="figure-img img-fluid rounded" width="678px">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2020-08-01.jpg" class="figure-img img-fluid rounded" width="576spx">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
		  <figure class="figure">
			<img src="<?php echo e(asset('image')); ?>/2020-07-26.jpg" class="figure-img img-fluid rounded" width="678spx">
			<figcaption class="figure-caption"></figcaption>
		  </figure>
	</div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
			  ...
			  <p> Berikut adalah infomasi tentang Hotel Mayangan </p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Jl. Pondok bali No.82, Mayangan, Legonkulon, Subang Regency, West Java 41254</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">0811-1259-055</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\projek2\resources\views/v_hotel.blade.php ENDPATH**/ ?>