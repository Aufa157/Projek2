            ...
            <div class="card-body p-0">
                ...
                <div class="row">
					...
					<div class="col-lg-5 d-none d-lg-block">
						<img src="<?php echo e(asset("SB Admin")); ?>/img/pexels-photo-2962392.jpeg">
					</div>
                    <div class="col-lg-7">
                        <div class="p-5">
                                ...
                                <div class="form-group">
                                    <div>
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Nama" name="name" value="<?php echo e(old('name')); ?>">
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\projek2\resources\views/v_register.blade.php ENDPATH**/ ?>