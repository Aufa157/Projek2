...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo e(asset('dashboard')); ?>/images/culinary.jpg');">
          	...
          	<div class="row">
          		<div class="col-md-5 ftco-animate">
		    				<div class="destination">
		    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo e(asset('dashboard')); ?>/images/ikan.jpg);">
                                    <img src="ikan.jpg">
  ...
  <script src="<?php echo e(asset('dashboard')); ?>/js/range.js"></script>
...
<?php /**PATH C:\Users\Daffa Hafizh R\OneDrive\Documents\Codingan\projek2\projek2\resources\views/v_tour.blade.php ENDPATH**/ ?>