...
<body oncontextmenu='return false' class='snippet-body'>
    ...
    <script>
        $(document).ready(function() {
            <?php if(session('registrasi')): ?>
                alert("<?php echo e(session('registrasi')); ?>");
            <?php endif; ?>
        });
    </script>
</body>
...
<?php /**PATH C:\xampp\htdocs\projek2\resources\views/v_login.blade.php ENDPATH**/ ?>