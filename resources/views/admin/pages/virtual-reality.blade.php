<x-layout bodyClass="g-sidenav-show  bg-gray-200 virtual-reality">
    ...
    <div class="border-radius-xl mx-2 mx-md-3 position-relative"
        style="background-image: url('{{ asset('Admin') }}/assets/img/vr-bg.jpg'); background-size: cover;">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto">
                                    <img class="w-50 float-end mt-n6 mt-lg-n4"
                                        src="{{ asset('Admin') }}/assets/img/small-logos/icon-sun-cloud.png" alt="image sun">
                                </div>
                            </div>
                            <div class="row mt-4">
